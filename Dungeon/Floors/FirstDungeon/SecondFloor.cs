...
namespace DeityOnceLost.Dungeon.Floors.FirstDungeon
{
    class SecondFloor : Floor
    {
        ...
        public SecondFloor() : base(SECOND_FLOOR_MAP_WIDTH, SECOND_FLOOR_MAP_HEIGHT, DEFAULT_GOLD_FROM_COMBAT_MIN, DEFAULT_GOLD_FROM_COMBAT_MAX)
        {
        ...
        private void setupReqCombatRoom()
        {
            ...
            //Combat.Encounter crawlerCombat = new Combat.Encounters.SingleLabTestSlime(); //FIXIT revert back
        ...
        private void setupRandomRooms()
        {
            ...
            //Combat.Encounter crawlers = new Combat.Encounters.SingleLabTestSlime(); //FIXIT revert back
